      ...
      {% for company_key in site.data.companies %}
        ...
        <div class="mui-company-card" style="background: var(--bg-elevated); border-radius: var(--mui-radius); padding: 2rem; box-shadow: var(--shadow-md); transition: all 0.3s ease; border: 1px solid var(--border-primary);">
          ...
          <div class="mui-company-info" style="background: var(--bg-primary); padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border: 1px solid var(--border-secondary);">
            ...
            {% if company.main.contact and company.main.contact.phone %}
          ...
          <div class="mui-company-actions" style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
            <a href="/companies/{{ company_key[0] }}/" class="mui-btn mui-btn--primary" style="flex: 1; display: flex; align-items: center; justify-content: center; text-decoration: none; padding: 0.75rem; border-radius: 8px;">
            ...
            <div class="mui-company-links" style="display: flex; gap: 0.5rem;">
              <a href="/companies/{{ company_key[0] }}/terms/" class="mui-link" title="Terms of Service" style="display: flex; align-items: center; padding: 0.75rem; border: 1px solid var(--border-primary); border-radius: 8px; text-decoration: none; color: var(--text-secondary);">
                <span class="material-icons">description</span>
              </a>
              <a href="/companies/{{ company_key[0] }}/refund-policy/" class="mui-link" title="Refund Policy" style="display: flex; align-items: center; padding: 0.75rem; border: 1px solid var(--border-primary); border-radius: 8px; text-decoration: none; color: var(--text-secondary);">
                  ...
                  {% if branch_key[0] != 'main' %}
                    <div class="mui-branch-item" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; background: var(--bg-primary); border-radius: 8px; border: 1px solid var(--border-secondary);">
                      <div class="mui-branch-info" style="flex: 1;">
                        <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">{{ company[branch_key[0]].name | default: branch_key[0] | capitalize }}</strong>
                        {% if company[branch_key[0]].contact and company[branch_key[0]].contact.phone %}
                          <div style="display: flex; align-items: center; color: var(--text-secondary); font-size: 0.9rem;">
                            ...
                            {{ company[branch_key[0]].contact.phone }}
                          </div>
                        {% endif %}
                        {% if company[branch_key[0]].contact and company[branch_key[0]].contact.address %}
                          <div style="display: flex; align-items: flex-start; color: var(--text-secondary); font-size: 0.85rem; margin-top: 0.25rem;">
                            ...
                            <span>{{ company[branch_key[0]].contact.address | truncate: 60 }}</span>
                          </div>
                        {% endif %}
                      </div>
                      <a href="/companies/{{ company_key[0] }}/{{ branch_key[0] }}/" class="mui-btn mui-btn--outline mui-btn--small" style="margin-left: 1rem; display: flex; align-items: center; text-decoration: none; padding: 0.5rem 1rem; border-radius: 6px;">
